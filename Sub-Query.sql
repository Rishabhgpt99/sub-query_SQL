...
/* OR */
select department_id,first-name,last_name,job-id
from employees 
where department_id= (select deprtment_id from departments where department_name = 'Finance');
...
/* no record exist */
select * from employees
where employee_id in (145,200,206);
...
/*11. Write a query to display all the information of the employees who does not work in those departments where some employees work whose manager id is within the range 100 and 200.*/
select * from employees 
where manager_id not in (select manager_id from employees where manager_id between 100 and 200);
...
select * from employees 
where salary in (select salary from employees order by salary desc limit 1);
...
/*14. Write a query to display the employee name (first name and last name) for all employees who work in a department with any employee whose name contains a ‘T’.*/
select first_name, last_name from employees
where department_id in (select department_id from employees where first_name like 'T%');

/*15. Write a query to display the employee number, name (first name and last name) and salary for all employees who earn more than the average salary and who work in a department with 
any employee with a ‘J’ in their name.*/
select employee_id as 'employee number',first_name,last_name,salary from employees
where salary > (select avg(salary) from employees where department_id in ( select department_id from employees where first_name like 'J%'));

/*16. Display the employee name (first name and last name), employee id, and job id for all employees whose department location is Toronto.*/
...
/*17. Write a query to display the employee number, name (first name and last name) and job id for all employees whose salary is smaller than any salary of those employees whose job title is Marketing Manager.*/
select employee_id,first_name,last_name,job_id from employees where salary < (select salary from employees where job_id = (select job_id from jobs where job_title = 'Marketing Manager')); 

/*18. Write a query to display the employee number, name (first name and last name) and job id for all employees whose salary is smaller than any salary of those employees whose job title 
is Marketing Manager. Exclude Job title Marketing Manager.*/
select employee_id, first_name,last_name,job_id from employees where salary < (select salary 


/*19. Write a query to display the employee number, name (first name and last name) and job title for all employees whose salary is more than any salary of those employees whose job title 
...
/*21. Write a query to display the employee number, name (first name and last name) and department for all employees for any existence of those employees whose salary in more than 3700.*/
...
/*23. Write a query to display the employee number, name (first name and last name) and job is column with a modified title SALESMAN for those employees whose job title is ST_MAN and DEVELOPER for 
whose job title is IT_PROG.*/


/*24. Write a query to display the employee number, name (first name and last name), salary and the SalaryStatus column with a title HIGH and LOW respectively for those employees whose salary 
